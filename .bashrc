...
alias pycharm="cd ~/Documents/pycharm/pycharm-ce-3-2-2017/bin; source pycharm.sh"
alias webex="~/Documents/firefox/firefox --profile ~/.mozilla/firefox/a86essyt.Webex --new-instance"
alias idea="cd ~/Documents/idea-IC-162.1628.40/bin/ && ./idea.sh"
alias atari='source ~/GAMES/start-ATARI.sh'
alias ccd='history | grep -E -v "ccd|grep|history" | grep cd | tail -n 7'
alias ansible-2-2-1='source ~/virtEnv/ansible-2-2-1/bin/activate'
alias backup='cd ~/Documents/SCRIPTS/backup2gdrive && source copydata.sh'
alias reset-blutooth='rfkill unblock bluetooth'
#bluetoothctl ; remove 08:DF:1F:D5:13:B1 ; scan on ; pair 08:DF:1F:D5:13:B1 
